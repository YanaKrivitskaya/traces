        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text('${visaDuration(visa)} / ${visa.durationOfStay} days',
                style: TextStyle(fontSize: 15.0)),
            Text('${daysLeft(visa, entryExits)} days left',
                ...
                entryExits.length > 0 ? Column(children: [
                  ListView.builder(shrinkWrap: true, physics: NeverScrollableScrollPhysics(),
                    ...
                    itemBuilder: (context, position) {
                      ...
                      return Container(padding: EdgeInsets.only(top: 10.0),
                            ...
                            //entry
                             Column(children: [Container(width: MediaQuery.of(context).size.width * 0.3,
                              child: Column(children: [
                                ...
                                crossAxisAlignment:CrossAxisAlignment.start))]),
                            //exit
                            entryExit.hasExit ? Column(children: [ Container(width: MediaQuery.of(context).size.width *0.3,
                              child: Column(children: [
                                ...
                                crossAxisAlignment: CrossAxisAlignment.start))])
                            : Container(),
                            Column(children: [Container(child: Column(children: [
                              ...
                              builder: (_) => BlocProvider<EntryExitBloc>(
                                  create: (context) =>
                                      EntryExitBloc(visasRepository: new FirebaseVisasRepository())
                                        ..add(GetEntryDetails(entryExit, visa, true, false)),
